	...
	<div class="feeds">
		...
		<div class="feeds__container">
			...
			<div class="feeds__textbox">
				<input type="text" class="feeds__input" v-model="caption" placeholder="새로운 소식을 남겨보세요." />
				<input type="file" accept="image/*" @change="onInputImage" ref="feedImage" />
				<button @click="onSubmit">제출</button>
				<img class="img__icon" src="@/assets/icons/photo.png" alt="photoIcon" />
			</div>
